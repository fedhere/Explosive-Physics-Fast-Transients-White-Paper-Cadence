...
To define our diagnostic, we collect the early-time observer-frame color and rate of change of brightness for several exemplar types of fast transients and fast features in Tables \ref{tab:1} and \ref{tab:2}, and discuss the main science goals for each in turn. {\bf MLG: why are table refs broken??}
